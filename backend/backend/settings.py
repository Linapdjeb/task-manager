...
SECRET_KEY = 'django-insecure-9l26tfzycx%rd_me!%ui3dz)#fu$$-(hhf6tmo1qf0+#j!h62x'
...
# whitelisting port 3000 aka react port
# so the backend wouldn't crash with the frontend
